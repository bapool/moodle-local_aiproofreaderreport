...
function xmldb_local_aiproofreaderreport_upgrade($oldversion) {
    ...
    if ($oldversion < 2026090102) {
        $table = new xmldb_table('local_aiproofreaderreport_optout');

        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('studentnumber', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null);
        $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('importedby', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);

        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_index('studentnumber', XMLDB_INDEX_NOTUNIQUE, ['studentnumber']);
